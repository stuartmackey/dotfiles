...
export PATH=/home/stuart/.local/bin:$PATH
...
export WORKING="$HOME/Working/GoReport/"
...
source $HOME/Working/GoReport/infrastructure/scripts/repair_remote_db.zsh

# /usr/bin/keychain --quiet $HOME/.ssh/id_ed25519
source $HOME/dotfiles/linux-ssh/.keychain/stuart-arch-sh
eval `ssh-agent -s`
ssh-add
